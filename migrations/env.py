...
from src.partners import partners,typePartner
from src.newsPartner import newsPartner
from src.tagsStage import tagsStage
from src.typeStage import typeStage
from src.stage import stage, stagePartner, stageTags
...
target_metadata = [
    classes.metadata,
    partners.metadata,
    newsPartner.metadata,
    tagsStage.metadata,
    typeStage.metadata,
    stage.metadata,
    stagePartner.metadata,
    stageTags.metadata,
    photo.metadata,
    video.metadata,
    typePartner.metadata,
    user.metadata,
    front.metadata,
    sub.metadata,
    back.metadata,
